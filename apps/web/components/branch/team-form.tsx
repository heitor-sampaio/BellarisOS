...
const ROLE_OPTIONS = [
  { value: 'BRANCH_ADMIN',  label: 'Gerente' },
...
export function TeamForm({ branchId, slug, isNetworkAdmin }: TeamFormProps) {
  const [open, setOpen] = useState(false)
  const [state, action, pending] = useActionState(createTeamMember, undefined)

  const roleOptions = isNetworkAdmin
    ? ROLE_OPTIONS
    : ROLE_OPTIONS.filter(r => r.value !== 'BRANCH_ADMIN')
